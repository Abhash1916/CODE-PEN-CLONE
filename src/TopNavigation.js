        ...
        <div>
            <div className="mainheader">
                <div className="right">
                    ...
                    <div className="text">
                        <h2>Code Editor {'\u00A0'}<FontAwesomeIcon size="xs" color="#fff" icon={faPencilAlt} /></h2>
                    </div>
                ...
                <div>
                    ...
                    <div className="buttons">
                         ...
                         <a target="_blank" href="https://codepen.io/features/pro"><button className="Topbutton1"><FontAwesomeIcon color="#ADAFBC" icon={faCog} /> {'\u00A0'}Setting</button></a>
